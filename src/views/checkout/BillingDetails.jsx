                        ...
                        >
                            <div className="row">
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="Full Name*" name="fullname" type="text" className="form-control"/>
                                </div>
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="Email*" name="email" type="email" className="form-control"/>
                                </div>
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="House Number And Street Name*" name="address" type="text" className="form-control"/>
                                </div>
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="Country*" name="country" type="text" className="form-control"/>
                                </div>
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="Town / City*" name="city" type="text" className="form-control"/>
                                </div>
                                <div className="col-xl-6 form-group mb-3">
                                    <TextInput label="Phone*" name="phone" type="phone" className="form-control"/>
                                </div>
                            </div>
